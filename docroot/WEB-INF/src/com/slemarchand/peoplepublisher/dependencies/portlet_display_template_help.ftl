...
You can use FreeMarker to define display templates for the People Publisher
portlet.
...
{$users}: the list of users that are being shown in this portlet

{$user}: the user when there's only one user
